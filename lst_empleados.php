...
$sql = "SELECT count(*) FROM paginas WHERE nombre='lst_empleados.php' AND nivel = $priv;";
        ...
        <div id="user" class="section contact-area">
            ...
            <div class="form-wrap text-white">
                ...
                <table class="table">
                  ...
                  <?PHP
                  $sql = "SELECT a.id, a.nombre, a.apellido_pat, a.apellido_mat, a.contratacion, a.salario, m.nombre
                  FROM empleados a 
                  INNER JOIN puestos m 
                  ON a.id_puesto = m.id;";
                  require_once("php/cls_Autos.php");
                  $objAuto = new cls_Autos();
                  ...
                  while($rs <> null){
                    echo "<tr>",
                      ...
                      "<td>",$rs[5],"</td>",
                      "<td>",$rs[6],"</td>",
                      "<td><a href='mdf_emps.php?id=$rs[0]'>Modificar</a>","</td>",
                      "<td>","</td>",
                      "</tr>";
                      $rs = $objAuto->sigAutos();
                  }
