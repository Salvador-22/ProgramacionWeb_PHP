            ...
            <div class="collapse navbar-collapse" id="navbar-collapse">
                <ul class="nav navbar-nav navbar-right" id="one-page-nav">
					...
					<ul  class="dropdown-menu" aria-labelledby="navbarDropdown">
					   ...
					   <li><a class="dropdown-item" href="actVentas.php">Modificación</a></li>
					</ul>
					</li>
                </ul>
            </div>
			...
			?>
                <div class="container">
                    <div class="row">
                        <div class="col-md-5 col-xs-12">
                            ...
                            <form id="frmVentAuto" class="contact-form" action="Ventas.php" method="post">
                                ...
                                <p>
                                	<label for="cocheID">Seleccione el ID del auto que va a ser vendido</label>
                              		<div class="form-group">
										<select class="form-control" id= "cocheID" name="cocheID">
                                    <?PHP
                                        if(isset($_POST['cocheID'])==null){
                                    ?>
									<option value="-1" selected >Seleccione el ID del Auto</option>
									<?PHP
								...
								<p>
                                    ...
                                    ?>
									  		<option value="-1" selected >Seleccione el ID del vendedor</option>
									 <?PHP
									 	require_once "php/cls_Autos.php";
                                ...
                                <p>
                                    ...
                                    ?>
                                            <option value="-1" selected >Seleccione el ID del cliente</option>
                                     <?PHP
                                        require_once "php/cls_Autos.php";
                    ...
                    $r = $objAutos->insertAutos($sql);
                           if($r == "")
                              $objUtiles->Msgbox("'AUTO DADO DE ALTA EXITOSAMENTE'");
                           else
