...
$sql = "SELECT count(*) FROM paginas WHERE nombre='altUsuarios.php' AND nivel = $priv;";
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-5 col-xs-12">
                            ...
                            <form id="frmAltUser" class="contact-form" action="altUsuarios.php" method="post">
                                <p>
                    ...
                    <div class="row">
                        <div class="col-md-5 col-xs-12">
                            ...
                            <form id="frmAltUser" class="contact-form" action="altUsuarios.php" method="post">
                                ...
                                <p>
                                    <input id="contratacion" type="date" name="contratacion" placeholder="contratacion"
                                        required>
                                </p>
                                <div class="form-group">
                                    <select class="form-control" id="tipo" name="tipo">
