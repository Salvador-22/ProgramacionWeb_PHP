...
if(isset($_SESSION['sessionwork']) != null)
{
	...
	$sql = "SELECT count(*) FROM paginas WHERE nombre='altReparaciones.php' AND nivel=$priv;";
	// el resultado del query es: 1 muestra el alta y 0 sin privilegios
	require_once "php/cls_Reparacioness.php";
	$objReparacion = new cls_Reparacioness();
	$r = $objReparacion->listReparaciones($sql);
	if($r[0] == 1)
	{
?>
			...
			?>
                    ...
                    <div class="row">
                        <div class="col-md-5 col-xs-12">
                            <div class="section-header style-2">
                                <h3 class="section-title">Alta de Reparaciones</h3>
                            </div>
               ...
               <div class="container">
                    <div class="row">
                        <div class="col-md-5 col-xs-12">
                            <div class="section-header style-2">
                                <h3 class="section-title">Agregra Reparacion</h3>
                            </div>
                            <form id="frmAltaEmpleados" class="contact-form" action="Empleados.php" method="post">
                                <label for="start">Start date:</label>
								...
								if($clie == -1)
								{
									echo "<div class='col-sm-4'>
									        <small id='modeloHelp' class='text-danger'>
											  Debes seleccionar un cliente de la lista
											</small>
									      </div>";
								}
                                ?>								
