        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbar-collapse">
                <ul class="nav navbar-nav navbar-right" id="one-page-nav">
					...
					<ul  class="dropdown-menu" aria-labelledby="navbarDropdown">
					   <li><a class="dropdown-item" href="altEmpleados.php">Alta</a></li>
					   <li><a class="dropdown-item" href="listar_reparaciones">Modificación</a></li>
					</ul>
					</li>
                </ul>
            </div>
    ...
    <div class="main-wrap"> 
        ...
        <div id="aa" class="section contact-area">
			...
			<?PHP
                ...
                $rsSrc = $objSrc->listReparaciones($sqlSrcReparacion);
                $objSrc->CerrarConn();
				//aquí
				 ...
				 <div class="row">
                        <div class="col-md-5 col-xs-12">
                            <div class="section-header style-2">
                                <h3 class="section-title">Modificación de Reparaciones</h3>
                            </div>
                            <h4>id :<?= $id_auto ?></h4>
					...
					$mec = $_POST["mecanico"];
					$clie = $_POST["cliente"];
					if($coch == -1 && $mec == -1 && $clie == -1) //-1 NO HA SELECIONADO NADA MODELO
					{
			     ?>
               <div class="container">
                    <div class="row">
