               ...
               <div class="container">
                    <div class="row">
                        <div class="col-md-5 col-xs-12">
                            ...
                            <form id="frmAltaEmpleados" class="contact-form" action="intEmpleados.php" method="post">
                                <p>
                                <input id="matricula" type="text" name="matricula" placeholder="Matricula" value="<?=$rsSrc[0]?>" required>
                                </p>
                                <p>
                                <input id="motor" type="text" name="motor" placeholder="Motor" value="<?=$rsSrc[1]?>" required>
                                </p>
								<div class="form-group">
