			...
			?>
                    ...
                    <div class="row">
                        <div class="col-md-5 col-xs-12">
                            <div class="section-header style-2">
                                <h3 class="section-title">Eliminar Puesto</h3>
                            </div>
                            <form id="frmElimPuesto" class="contact-form" action="eliminarPuesto.php" method="post">
                                
                                <input id="id" type="number" name="id" placeholder="Identificador del puesto:" required>
                                </p>	
				...
				<?PHP
                        ...
                        <div class="row">
                            <div class="col-md-5 col-xs-12">
                                <div class="section-header style-2">
                                    <h3 class="section-title">Puesto eliminado</h3>
                                    <br/>
                                    <table border="2">
                                    <tr>
                                        <th>Identificador </th>
                    ...
                    <?PHP
						...
						if($r>0){
							...
							$objUtiles->MsgBox("'ERROR: El puesto NO existe!'");
						}
