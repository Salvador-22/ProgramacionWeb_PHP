        ...
        <div id="aa" class="section contact-area">
			...
			?>
                    ...
                    <div class="row">
                        <div class="col-md-5 col-xs-12">
                            <div class="section-header style-2">
                                <h3 class="section-title">Eliminar Empleado</h3>
                            </div>
                            <form id="frmElimEmpleado" class="contact-form" action="eliminarEmpleado.php" method="post">
                                
                                <input id="id" type="number" name="id" placeholder="Identificador de empleado:" required>
                                </p>	
				...
				<?PHP
					...
					POST*/
					$id = $_POST["id"];
					if($id == "") //-1 NO HA SELECIONADO NADA
					{
			     ?>
				<div class="container">
                    <div class="row">
				...
				<?PHP
                        ...
                        <div class="row">
                            <div class="col-md-5 col-xs-12">
                                <div class="section-header style-2">
                                    <h3 class="section-title">Empleado eliminado</h3>
                                    <br/>
                                    <table border="2">
                                    <tr>
                                        <th>Identificador </th>
                                     ...
                                     <?PHP
                                          ...
                                          $sql = "SELECT e.id, e.nombre, e.apellido_pat, e.apellido_mat, e.contratacion, p.nombre, e.salario  
                    ...
                    <?PHP
						...
						if($r>0){
							$SQL="DELETE FROM empleados WHERE  id=$id;";
									...
									if($r == ""){
										$objUtiles->MsgBox("'ELIMINADO!'");
									}
									else{
										$objUtiles->MsgBox("'Ocurrió un ERROR al eliminar!!!'");
									}
