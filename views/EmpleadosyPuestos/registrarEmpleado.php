        ...
        <div id="aa" class="section contact-area">
			...
			?>
                    ...
                    <div class="row">
                        <div class="col-md-5 col-xs-12">
                            <div class="section-header style-2">
                                <h3 class="section-title">Empleado nuevo</h3>
                            </div>
                            <form id="frmRegEmpleado" class="contact-form" action="registrarEmpleado.php" method="post">
								<p>
								...
								<p>
                                <input id="contratacion" type="text" name="contratacion" placeholder="Contratacion fecha:año/mes/dia" required>
                                </p>
								<div class="form-group">
									<select class="form-control" id= "puesto" name="puesto">
									  ...
									  $sql = "SELECT DISTINCT id,nombre,descripcion FROM puestos;";
				...
				<?PHP
					...
					POST*/
					$pues = $_POST["puesto"];
					if($pues == -1) //-1 NO HA SELECIONADO PUESTO
					{
			     ?>
				...
				<?PHP
						...
						$objAutos = new cls_Autos();
						  ...
						  $sql = "SELECT nombre,apellido_pat,apellido_mat  FROM empleados WHERE nombre='$nom' AND apellido_pat = '$papell' AND apellido_mat = '$sapell';";
						  $n = $objAutos->existAuto($sql);

						  if($n == 0)
						  {
							$sql = "INSERT INTO empleados VALUES ('','$nom','$papell','$sapell','$cont','$sal','$pues','1');";

						   $r = $objAutos->insertAutos($sql);

						  }
						  else
							  $objUtiles->Msgbox("'Error: Ya existe el empleado'");
