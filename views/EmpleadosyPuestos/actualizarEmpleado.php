        ...
        <div id="aa" class="section contact-area">
			...
			?>
                    ...
                    <div class="row">
                        <div class="col-md-5 col-xs-12">
                            <div class="section-header style-2">
                                <h3 class="section-title">Modificación de Empleado</h3>
                            </div>
                            <form id="frmRegEmpleado" class="contact-form" action="actualizarEmpleado.php" method="post">
                                <div class="form-group">
								<p>
                                <input id="id" type="text" name="id" placeholder="ID de empleado:" required>
                                </p>
								<p>
                                <input id="nombre" type="text" name="nombre" placeholder="Nombre" required>
                                </p>
								<p>
                                <input id="primerapellido" type="text" name="primerapellido" placeholder="Primer apellido" required>
                                </p>
								<p>
                                <input id="segundoapellido" type="text" name="segundoapellido" placeholder="Segundo apellido" required>
                                </p>
								<p>
                                <input id="contratacion" type="contratacion" name="contratacion" placeholder="Contratacion fecha:año/mes/dia" required>
                                </p>
								<div class="form-group">
									<select class="form-control" id= "puesto" name="puesto">
									  ...
									  $sql = "SELECT DISTINCT nombre,descripcion FROM puestos;";
                                ...
                                <p>
                                <input id="salario" type="number" name="salario" placeholder="Salario" required>
                                </p>	
				...
				<?PHP
						...
						$id = $_POST['id'];
						$nom = $_POST['nombre'];
						$papell = $_POST['primerapellido'];
						$sapell = $_POST['primerapellido'];
						$cont = $_POST['contratacion'];
						$pues = $_POST['puesto'];
						$sal = $_POST['salario'];
						...
						if($r>0){
							$SQL="UPDATE empleados
									...
									if($r == ""){
										$objUtiles->MsgBox("'ACTUALIZACIÓN DE EMPLEADO EXITOSA!'");
									}
									else{
							...
							$objUtiles->MsgBox("'ERROR: El empleado NO existe!'");
						}
				...
				<div class="container">
                    <div class="row">
                        <div class="col-md-5 col-xs-12">
                            ...
                            <form id="frmRegVenta" class="contact-form" action="actualizarVenta.php" method="post">
                                <div class="form-group">
								<p>
                                <input id="id" type="text" name="id" placeholder="ID de la venta:" required>
                                </p>
