                    ...
                    <div class="row">
                        <div class="col-md-5 col-xs-12">
                            <div class="section-header style-2">
                                <h3 class="section-title">Modificación de Puesto</h3>
                            </div>
                            <form id="frmRegPuesto" class="contact-form" action="actualizarPuesto.php" method="post">
                                <div class="form-group">
								<p>
                                <input id="id" type="text" name="id" placeholder="ID de puesto:" required>
                                </p>
								<p>
				...
				<?PHP
						...
						if($r>0){
							$SQL="UPDATE puestos
									...
									if($r == ""){
										$objUtiles->MsgBox("'ACTUALIZACIÓN DE PUESTO EXITOSA!'");
									}
									else{
