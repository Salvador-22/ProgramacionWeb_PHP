                    ...
                    <div class="row">
                        <div class="col-md-5 col-xs-12">
                            ...
                            <form id="frmIniS" class="contact-form" action="login.php" method="post">
                                <p>
                                <input id="usuario" type="text" name="usuario" placeholder="Nombre del Usuario" required>
                                </p>
                                <p>
                                <input id="Password" type="text" name="Password" placeholder="Contreseña" required>
                                </p>								
                                <button type="submit" class="btn"><i class="fa fa-paper-plane"></i> Iniciar</button>
