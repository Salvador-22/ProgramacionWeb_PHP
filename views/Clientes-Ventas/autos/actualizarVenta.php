        ...
        <div id="aa" class="section contact-area">
			...
			?>
                    ...
                    <div class="row">
                        <div class="col-md-5 col-xs-12">
                            <div class="section-header style-2">
                                <h3 class="section-title">Modificación de Ventas</h3>
                            </div>
				...
				<div class="container">
                    <div class="row">
                        <div class="col-md-5 col-xs-12">
                            ...
                            <form id="frmAltaAutos" class="contact-form" action="actualizarVenta.php" method="post">
                                <div class="form-group">
								<p>
                                <input id="id" type="text" name="id" placeholder="ID de la venta:" required>
                                </p>
				...
				<?PHP
						...
						$SQL="SELECT * FROM `coches_venta` WHERE id=$id;";	
						...
						if($r>0){
							...
							$objUtiles->MsgBox("'ERROR: La venta que esta buscando NO existe!'");
						}
