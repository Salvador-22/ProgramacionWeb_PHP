...
$sql = "SELECT count(*) FROM paginas WHERE nombre='mdf_emps.php' AND nivel = $priv;";
    ...
    <div class="main-wrap"> 
        ...
        <div id="aa" class="section contact-area">
			...
			<?PHP
                ...
                $sqlSrcEmp = "SELECT e.nombre, e.apellido_pat, e.apellido_mat, e.contratacion, e.salario, p.id
                FROM empleados e JOIN puestos p ON e.id_puesto = p.id
                WHERE e.id = $id_emp;";
                $rs = $objSrc->listAutos($sqlSrcEmp);
                $objSrc->CerrarConn();
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-5 col-xs-12">
                            ...
                            <form id="frmAltaEmp" class="contact-form" action="intEmp.php" method="post">
                                <p>
                                <input id="id" name="id" value=<?= $id_emp ?> type="hidden">
                                </p>
                                <p>
                                <input id="nombre" type="text" name="nombre" placeholder="nombre" value="<?= $rs[0] ?>" required>
                                </p>
                                <p>
                                <input id="apePat" type="text" name="apePat" placeholder="Apellido Paterno" value="<?= $rs[1] ?>" required>
                                </p>
                                <p>
                                <input id="apeMat" type="text" name="apeMat" placeholder="Apellido Materno" value="<?= $rs[2] ?>" required>
                                </p>
                                <p>
                                <input id="contratacion" type="date" name="contratacion" placeholder="contratacion" value="<?= $rs[3] ?>" required>
                                </p>
                                <p>
                                <input id="salario" type="text" name="salario" placeholder="salario" value="<?= $rs[4] ?>" required>
                                </p>
